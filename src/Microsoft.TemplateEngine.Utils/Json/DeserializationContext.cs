...
//        public TokenBuilder<T> IfObject<TResult>(string storeAs, DeserializationPlan<TResult> deserializationPlan)
//        {
//            if (!(_objectBuilder is null))
//            {
//                throw new InvalidOperationException("Duplicate handler specification");
...
//            _objectBuilder = _objectBuilder ?? new ObjectBuilder<TokenBuilder<T>>((obj, context) => context[storeAs] = deserializationPlan.Deserialize(obj), this);
//            return this;
//        }
...
//        private readonly Action<IJsonObject, DeserializationContext> _explicitHandler;

//        public ObjectBuilder(Action<IJsonObject, DeserializationContext> explicitHandler, T parent)
//        {
//            _explicitHandler = explicitHandler;
//            _parent = parent;
//        }
...
//        {
//            if (!(_explicitHandler is null))
//            {
//                return _explicitHandler;
//            }
